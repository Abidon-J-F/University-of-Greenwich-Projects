...
- Coursework: main panel GUI that presents all the information to the user about a selected project
    anything with "_gui" on the end is a sub-menu used to create instance of the same name
...
-The "task leads from" field in the task creation menu takes in a list of all the tasks that are going to file in to this new one. Simply list them out separated with a comma, no spaces needed (A, B, C etc.)
    If it’s the first task in a project, just type "null"
